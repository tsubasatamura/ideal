 ...
 * Generated at: 2021-06-16 14:17:02 UTC
...
if(userName==null){
      ...
      out.write("\t\t\t\t\t<li class=\"active\"><a href=\"ReservationStatusSvl\">予約状況<br><span>Reserve</span></a></li>\r\n");
      ...
      out.write("\r\n");
      java.util.HashMap statusMap = null;
      statusMap = (java.util.HashMap) _jspx_page_context.getAttribute("statusMap", javax.servlet.jsp.PageContext.REQUEST_SCOPE);
      if (statusMap == null){
        statusMap = new java.util.HashMap();
        _jspx_page_context.setAttribute("statusMap", statusMap, javax.servlet.jsp.PageContext.REQUEST_SCOPE);
      }
      out.write('\r');
      out.write('\n');
      out.write('	');
 HCalendar mc = (HCalendar) request.getAttribute("mc"); 
      ...
      out.write("\t\t<p>◎：貸切予約（2～30名様）および個人予約（2～6名様）が可能</p>\r\n");
      out.write("\t\t<p>〇：個人（2～6名様）の予約が可能</p>\r\n");
      out.write("\t\t<p>×：予約不可</p>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
