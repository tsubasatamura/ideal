 ...
 * Generated at: 2021-06-17 15:37:02 UTC
...
return;
    ...
    try {
      ...
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      java.util.List<model.Course> courseList = null;
      courseList = (java.util.List<model.Course>) _jspx_page_context.getAttribute("courseList", javax.servlet.jsp.PageContext.REQUEST_SCOPE);
      if (courseList == null){
      ...
      out.write('\r');
      out.write('\n');
      java.util.List<model.Menu> menuList = null;
      menuList = (java.util.List<model.Menu>) _jspx_page_context.getAttribute("menuList", javax.servlet.jsp.PageContext.REQUEST_SCOPE);
      if (menuList == null){
...
if(userName==null){
      ...
      out.write("<p class=\"kind\">■コース料理</p>\r\n");
...
if(Objects.equals(courseList.get(0).getCoursePhotoName(),null)||Objects.equals(courseList.get(0).getCoursePhotoName(),"")){ 
      out.write("\r\n");
      out.write("<span class=\"coursename\">");
      out.print(courseList.get(0).getCourseName() );
      out.write("</span><span class=\"price\">");
      out.print( nf.format(courseList.get(0).getPrice()) );
      out.write("</span>\r\n");
}else{ 
      out.write("\r\n");
      out.write("<span class=\"coursename\">");
      ...
      out.print( nf.format(courseList.get(0).getPrice()) );
      out.write("</span>\r\n");
      out.write("<div class=\"photo\"><img id=\"img\" src=\"upload/");
      out.print( courseList.get(0).getCoursePhotoName() );
      out.write("\" /></div>\r\n");
} 
      out.write("\r\n");
      out.write("<p class=\"detail\">");
      out.print(courseList.get(0).getDetail() );
      out.write("</p>\r\n");
      out.write("<p class=\"menuname\">");
      out.print(courseList.get(0).getMenuName() );
      out.write("</p>\r\n");
} 
      out.write('\r');
      out.write('\n');
...
if(Objects.equals(courseList.get(i+1).getCoursePhotoName(),null)||Objects.equals(courseList.get(i+1).getCoursePhotoName(),"")){ 
      out.write("\r\n");
      out.write("<span class=\"coursename\">");
      out.print(courseList.get(i+1).getCourseName() );
      out.write("</span><span class=\"price\">");
      out.print( nf.format(courseList.get(i+1).getPrice()) );
      out.write("</span>\r\n");
}else{ 
      out.write("\r\n");
      out.write("<span class=\"coursename\">");
      ...
      out.write("</span>\r\n");
      out.write("<div class=\"photo\"><img id=\"img\" src=\"upload/");
      out.print( courseList.get(i+1).getCoursePhotoName() );
      out.write("\" /></div>\r\n");
} 
      out.write("\r\n");
      out.write("<p class=\"detail\">");
      out.print(courseList.get(i+1).getDetail() );
      out.write("</p>\r\n");
} 
      out.write("\r\n");
      out.write("<p class=\"menuname\">");
      out.print(courseList.get(i+1).getMenuName() );
      out.write("</p>\r\n");
} 
      out.write('\r');
      out.write('\n');
...
if(700<=menuList.get(i).getTypeId()&&menuList.get(i).getTypeId()<=720){ 
      out.write("\r\n");
      out.write("<span class=\"mname\">");
      out.print(menuList.get(i).getMenuName() );
      out.write('\r');
      out.write('\n');
if(Objects.equals(menuList.get(i).getMenuPhotoName(),null)||Objects.equals(menuList.get(i).getMenuPhotoName(),"")){ 
      out.write("\r\n");
      out.write("</span><span class=\"menuprice\">");
      out.print(nf.format(menuList.get(i).getPrice()) );
      out.write("</span>\r\n");
}else{ 
      out.write("\r\n");
      out.write("</span><span class=\"menuprice\">");
      out.print(nf.format(menuList.get(i).getPrice()) );
      out.write("</span>\r\n");
      out.write("<div class=\"menuphoto\"><img id=\"menuimg\" src=\"upload/");
      out.print( menuList.get(i).getMenuPhotoName() );
      out.write("\" /></div>\r\n");
} 
      out.write('\r');
      out.write('\n');
      ...
      out.write("\r\n");
      out.write("<div>&emsp;</div>\r\n");
      out.write("<p class=\"return\"><a href=\"#\" onclick=\"window.history.back()\">戻る</a></p>\r\n");
      out.write("</section>\r\n");
      out.write("</article>\r\n");
      out.write("</div>\r\n");
      out.write("<!-- フッター -->\r\n");
