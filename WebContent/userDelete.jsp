...
<form id="cusfrm" name="cusfrm" action="UserOperationSvl" method="post"
				...
				<table id="usertable">
					...
					<tr>
						<td id="index">郵便番号</td>
						<td >
							<jsp:getProperty name="userInfo" property="postcode"/>
						</td>
					</tr>
					<tr>
						<td id="index">住所</td>
						<td >
							<jsp:getProperty name="userInfo" property="address"/>
						</td>
					</tr>
					<tr>
						<td id="index">電話番号</td>
						<td>
							<jsp:getProperty name="userInfo" property="phone"/>
						</td>
					</tr>
					<tr>
						<td id="index">e-mail</td>
						<td>
							<jsp:getProperty name="userInfo" property="mail"/>
						</td>
					</tr>
					<tr>
				...
				<input type="hidden" name="mail" value="<jsp:getProperty name="userInfo" property="mail"/>"/>
