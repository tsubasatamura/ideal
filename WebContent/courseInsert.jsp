...
<jsp:useBean id="Course"  class="java.util.ArrayList" scope="request"/>
<jsp:useBean id="Coursectl"  class="java.util.ArrayList" scope="request"/>
...
<tr>
<th>コメント</th>
<td><textarea  name="detail"  cols="30"  rows="4"></textarea>
</td>
</tr>
<tr>
<th>前菜</th>
